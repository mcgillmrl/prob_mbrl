...
class SdLBFGS(Optimizer):
    ...
    Huidong Liu (h.d.liew@gmail.com) and
    Yingkai Li (yingkaili2023@u.northwestern.edu)
    .. warning::
    ...
    Arguments:
        ...
        lr_decay (bool): whether to perform learning rate decay
                         (default: True).
    ...
    [1] Wang, Xiao, et al. "Stochastic quasi-Newton methods for nonconvex
